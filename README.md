...
→ [See case studies at **systemsforge.build**](https://systemsforge.build/)
...
**3D / Geometry:** Three.js · React Three Fiber · Rhino + Grasshopper · Open3D · CATIA  
**Web:** React · Svelte · Node.js · Firebase · REST APIs  
**Fabrication:** CNC automation · sheet metal forming · GD&T · Leica total station · robotic workflows  

---

### Writing & research

- [Site Reconciliation: Point Cloud Alignment for Construction Accuracy](https://systemsforge.build/) — AEI 2025  
- [Direct-Delivery of Pose: Human-Robot Workflows](https://systemsforge.build/) — ACADIA 2024  
- [Automation in the Field: SurveyLink](https://doi.org/10.1080/24751448.2022.2116230) — Taylor & Francis (peer-reviewed)  
- AEC Tech NYC Hackathon — **Best Hack** (2022, 2023)  
- [parametric{COLAB}](https://systemsforge.build/) — 190+ sessions on computational manufacturing workflows (2016–present)
